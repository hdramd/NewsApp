...
namespace NewsApp.Infra.Data.Sql.Commands.Migrations
{
    ...
    [Migration("20230103115154_add-image-entity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsApp.Core.Domain.Images.Entities.Image", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("NewsApp.Core.Domain.News.Entities.NewsImageMapping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("NewsApp.Core.Domain.News.Entities.NewsImageMapping", b =>
                {
                    b.HasOne("NewsApp.Core.Domain.Images.Entities.Image", "Image")
                        .WithMany("NewsImageMappings")
            ...
            modelBuilder.Entity("NewsApp.Core.Domain.Images.Entities.Image", b =>
                {
                    b.Navigation("NewsImageMappings");
                });
